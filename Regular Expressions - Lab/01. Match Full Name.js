...
// // 6. To prevent capturing of letters across new lines, put "\b" at the beginning and the end of your reg
...
function matchFullName() {
    ...
    let matchName = patern.exec(text)

    while (matchName) {
        result.push(matchName[0])
        matchName = patern.exec(text)
    }
